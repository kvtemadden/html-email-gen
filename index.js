...
modalData = () => {
  ...
  localStorage.getItem("subject") == null
    ? (document.querySelector('[data-field="subject"]').value = "")
    : (document.querySelector('[data-field="subject"]').value =
        localStorage.getItem("subject"));
  localStorage.getItem("brand") == null
    ? (document.querySelector('[data-field="brand"]').value = "")
    : (document.querySelector('[data-field="brand"]').value =
        localStorage.getItem("brand"));
  localStorage.getItem("salu") == null
    ? (document.querySelector('[data-field="salu"]').value = "")
    : (document.querySelector('[data-field="salu"]').value =
        localStorage.getItem("salu"));
  localStorage.getItem("signOff") == null
    ? (document.querySelector('[data-field="signOff"]').value = "")
    : (document.querySelector('[data-field="signOff"]').value =
        localStorage.getItem("signOff"));
  localStorage.getItem("em") == null
    ? (document.querySelector('[data-field="em"]').value = "")
    : (document.querySelector('[data-field="em"]').value =
        localStorage.getItem("em"));
  localStorage.getItem("email-1") == null
    ? (document.querySelector('[data-field="email-1"]').value = "")
    : (document.querySelector('[data-field="email-1"]').value =
        localStorage.getItem("email-1"));
...
document.addEventListener(
  ...
  function (event) {
    ...
    if (
      ...
      event.target.matches("#next-step") ||
      event.target.matches("#prev-step")
    ) {
...
buildEmail = (e) => {
  ...
  let block1 =
    (inclSal == "Yes" ? salu : "") +
    document.getElementById("21").value.replace(/(?:\r\n|\r|\n)/g, "<br/>") +
    (inclSO == "Yes" ? sOff : "");
  let block2 =
    (inclSal == "Yes" ? salu : "") +
    document.getElementById("22").value.replace(/(?:\r\n|\r|\n)/g, "<br/>") +
    (inclSO == "Yes" ? sOff : "<br/>") +
    fwd +
    subj +
    (inclSal == "Yes" ? salu : "") +
    document.getElementById("21").value.replace(/(?:\r\n|\r|\n)/g, "<br/>") +
    (inclSO == "Yes" ? sOff : "<br/>"); // email 2
  let block3 =
    (inclSal == "Yes" ? salu : "") +
    document.getElementById("23").value.replace(/(?:\r\n|\r|\n)/g, "<br/>") +
    (inclSO == "Yes" ? sOff : "<br/>") +
    fwd +
    fwdSubj +
    block2; // email 3
...
<table class="body-wrap" style="background-color: #ffffff; box-sizing: border-box; font-family: Calibri, sans-serif; font-size: 16px; line-height: 26px; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%" bgcolor="#ffffff">
  <tr>
    <td class="container" style="box-sizing: border-box; clear: both !important; display: block !important; margin: 0; max-width: 600px !important; overflow: visible; vertical-align: top; padding-left: 0px;" valign="top">
    ${
      e == 21
        ? block1
        : e == 22
    ...
    ${
      brand == "T4C"
        ...
        : brand == "Response"
        ? ""
        : `<a href='https://coburgbanks.co.uk/book-a-call/'><span>Book a call in my diary </span></a> |  <a href='https://coburgbanks.co.uk/${brand.toLowerCase()}-recruitment-agencies/'><span>coburgbanks.co.uk</span></a>`
    }
     <br/><br/>
    <strong><span style="color:${
      brand == "IT"
        ...
        ? "#970007"
        : "#A9B012"
    };font-size:11.0pt">${cons}</span></strong><br/>
    ...
    <br /><br /></td>
        ...
        <div class="content" style="box-sizing: border-box; display: block; margin: 0; max-width: 600px; overflow: visible">
        <table width="100%" cellpadding="0" cellspacing="0" style="box-sizing: border-box; mso-table-lspace: 0pt; mso-table-rspace: 0pt">
          <tr style="box-sizing: border-box; "> 
          </tr>
        </table>
        </div>
        <div class="content" style="box-sizing: border-box; max-width: 600px; overflow: visible; display: block; margin: 0;">
        <table width="100%" cellpadding="0" cellspacing="0" style="box-sizing: border-box; mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
          <tr style="box-sizing: border-box;">
